...
"background-color: rgb(255, 255, 127);")
        ...
        self.keyPictureLabel.setGeometry(QRect(380, 310, 131, 91))
        ...
        self.readLicenceBarcodelineEdit.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.readLicenceBarcodelineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.readLicenceBarcodelineEdit.setInputMethodHints(Qt.InputMethodHint.ImhNone)
        ...
        self.teacherPictureLabel.setInputMethodHints(Qt.InputMethodHint.ImhHiddenText)
        ...
        self.rentSuccedLabel.setGeometry(QRect(490, 200, 161, 31))
        font3 = QFont()
        ...
        self.renFailLabel.setGeometry(QRect(460, 240, 191, 31))
        ...
        self.keyBarcodeSucced.setGeometry(QRect(450, 500, 211, 41))
        font4 = QFont()
        ...
        self.keyBarcodefailLabel.setGeometry(QRect(440, 450, 221, 41))
        ...
        self.carPictureLabel.setGeometry(QRect(520, 330, 141, 41))
