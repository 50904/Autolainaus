...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QRect(10, 0, 241, 471))
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.label = QLabel(self.frame)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(30, 10, 181, 211))
        self.label.setPixmap(QPixmap(u":/pictures/docs/student.png"))
        self.label.setScaledContents(True)
        self.lineEdit = QLineEdit(self.frame)
        self.lineEdit.setObjectName(u"lineEdit")
        self.lineEdit.setGeometry(QRect(40, 240, 161, 81))
        font = QFont()
        ...
        self.pushButton.setGeometry(QRect(90, 370, 61, 41))
        font1 = QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.resetPositionsPushButton.setGeometry(QRect(480, 20, 121, 51))
        self.resetPositionsPushButton.setFont(font1)
        self.resetPositionsPushButton.setStyleSheet(u"background-color: rgb(24, 0, 72);\n"
"color: rgb(255, 255, 255);")
        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(131, 490, 423, 62))
        ...
        self.gridLayout.addWidget(self.lastNameLineEdit, 0, 0, 2, 1)

        self.pushButton_3 = QPushButton(self.widget)
        self.pushButton_3.setObjectName(u"pushButton_3")

        self.gridLayout.addWidget(self.pushButton_3, 0, 1, 2, 2)

        self.firstNameLineEdit = QLineEdit(self.widget)
        self.firstNameLineEdit.setObjectName(u"firstNameLineEdit")

        self.gridLayout.addWidget(self.firstNameLineEdit, 2, 0, 2, 1)
        ...
        self.lastFocusPushButton.setStyleSheet(u"background-color: rgb(255, 140, 46);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lastFocusPushButton.setText(QCoreApplication.translate("MainWindow", u"LastFocus", None))
    # retranslateUi
