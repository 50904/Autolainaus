...
class DbConnection():
    ...
    def filterColumsFromTable(self, table: str, columns: list, filter) -> list:
        """Filters data from table or view according to filter string

        Args:
            table (str): Name of the table or view
            columns (list): columns to include into a resultset
            filter (_type_): SQL code for the WHERE clause
        ...
        # Metodi, jolla haetaan ehdot täyttävä
    ...
    def getPgTimestamp(self) -> str:
        ...
        try:
            ...
            # Määritellään SQL lause, joka palauttaa aikleiman ja aikavyöhykkeen
