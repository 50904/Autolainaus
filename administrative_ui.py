...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ssnLineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.lastNameLineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.emailLineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
...
"color: rgb(255, 255, 255);")
        ...
        self.vehicleClassLineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.firstNameLineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        self.deleteLownerPushButton = QPushButton(self.lenderTab)
        self.deleteLownerPushButton.setObjectName(u"deleteLownerPushButton")
        self.deleteLownerPushButton.setGeometry(QRect(340, 20, 151, 21))
        self.deleteLownerPushButton.setStyleSheet(u"background-color: rgb(255, 0, 0);\n"
"color: rgb(255, 255, 255);")
        ...
        self.registerNumber = QLabel(self.vechileTab)
        self.registerNumber.setObjectName(u"registerNumber")
        self.registerNumber.setGeometry(QRect(10, 30, 101, 16))
        font1 = QFont()
        font1.setPointSize(9)
        font1.setBold(False)
        self.registerNumber.setFont(font1)
        ...
        self.registerNumberlineEdit.setClearButtonEnabled(True)
        self.manufacturerLineEdit = QLineEdit(self.vechileTab)
        self.manufacturerLineEdit.setObjectName(u"manufacturerLineEdit")
        self.manufacturerLineEdit.setGeometry(QRect(110, 60, 141, 20))
        ...
        self.modelYearLineEdit = QLineEdit(self.vechileTab)
        self.modelYearLineEdit.setObjectName(u"modelYearLineEdit")
        self.modelYearLineEdit.setGeometry(QRect(110, 120, 141, 20))
        ...
        self.capacityLineEdit = QLineEdit(self.vechileTab)
        self.capacityLineEdit.setObjectName(u"capacityLineEdit")
        self.capacityLineEdit.setGeometry(QRect(110, 150, 141, 20))
        ...
        self.saveVehiclePushButton.setGeometry(QRect(270, 210, 81, 23))
        font2 = QFont()
...
"color: rgb(247, 247, 247);")
        ...
        self.printBarcodeButton.setGeometry(QRect(270, 30, 81, 23))
...
"color: rgb(255, 255, 255);")
        self.vechicleCatalogTableWidget = QTableWidget(self.vechileTab)
        if (self.vechicleCatalogTableWidget.columnCount() < 7):
            self.vechicleCatalogTableWidget.setColumnCount(7)
        if (self.vechicleCatalogTableWidget.rowCount() < 8):
            self.vechicleCatalogTableWidget.setRowCount(8)
        self.vechicleCatalogTableWidget.setObjectName(u"vechicleCatalogTableWidget")
        self.vechicleCatalogTableWidget.setGeometry(QRect(0, 280, 721, 271))
        self.vechicleCatalogTableWidget.viewport().setProperty(u"cursor", QCursor(Qt.CursorShape.ForbiddenCursor))
        self.vechicleCatalogTableWidget.setRowCount(8)
        self.vechicleCatalogTableWidget.setColumnCount(7)
        self.label_31 = QLabel(self.vechileTab)
        self.label_31.setObjectName(u"label_31")
        self.label_31.setGeometry(QRect(600, 260, 111, 16))
        self.vehicleOwnerLineEdit = QLineEdit(self.vechileTab)
        self.vehicleOwnerLineEdit.setObjectName(u"vehicleOwnerLineEdit")
        self.vehicleOwnerLineEdit.setGeometry(QRect(110, 210, 141, 20))
        self.vehicleOwnerLineEdit.setClearButtonEnabled(True)
        self.vehicleTypeLabel = QLabel(self.vechileTab)
        self.vehicleTypeLabel.setObjectName(u"vehicleTypeLabel")
        self.vehicleTypeLabel.setGeometry(QRect(10, 180, 91, 16))
        self.vehicleOwnerLabel = QLabel(self.vechileTab)
        self.vehicleOwnerLabel.setObjectName(u"vehicleOwnerLabel")
        self.vehicleOwnerLabel.setGeometry(QRect(10, 210, 91, 16))
        self.openPicturePushButton = QPushButton(self.vechileTab)
        self.openPicturePushButton.setObjectName(u"openPicturePushButton")
        self.openPicturePushButton.setGeometry(QRect(270, 120, 81, 61))
        ...
        font3.setBold(False)
        self.vehicleTypeComboBox.setFont(font3)
        self.removeVehiclePushButton = QPushButton(self.vechileTab)
        self.removeVehiclePushButton.setObjectName(u"removeVehiclePushButton")
        self.removeVehiclePushButton.setGeometry(QRect(270, 70, 81, 23))
...
"color: rgb(255, 255, 255);")
        ...
        self.groupNameLineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
        ...
        self.responsibleLineEdit.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
...
"color: rgb(255, 255, 255);")
        ...
        self.saveGroupTabelWidget.viewport().setProperty(u"cursor", QCursor(Qt.CursorShape.ForbiddenCursor))
        self.saveGroupTabelWidget.setRowCount(10)
        self.saveGroupTabelWidget.setColumnCount(2)
        ...
        self.deleteGroupPushButton = QPushButton(self.groupTab)
        self.deleteGroupPushButton.setObjectName(u"deleteGroupPushButton")
        self.deleteGroupPushButton.setGeometry(QRect(300, 20, 121, 21))
...
"color: rgb(249, 249, 249);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deleteLownerPushButton.setText(QCoreApplication.translate("MainWindow", u"poista", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.lenderTab), QCoreApplication.translate("MainWindow", u"Lainaajat", None))
        self.registerNumber.setText(QCoreApplication.translate("MainWindow", u"Rekisterinumero", None))
